        ...
        <>
          <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 16 }}>
            ...
            <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.8)', lineHeight: 1.9 }}>
              <div>
                {tl('成员', 'Members')}: {rows.length} · {tl('直连', 'P2P')}:{' '}
                {rows.length - relayCount - offlineCount} · {tl('中继', 'Relay')}: {relayCount}
              </div>
              <div>
          ...
          <div
            style={{
              background: 'rgba(124,207,0,0.08)',
          ...
          >
            ...
            {suggestions.map((s, i) => (
              <div
                key={i}
                style={{ fontSize: 12, color: 'rgba(255,255,255,0.8)', lineHeight: 1.7 }}
              >
                · {s}
              </div>
            ))}
