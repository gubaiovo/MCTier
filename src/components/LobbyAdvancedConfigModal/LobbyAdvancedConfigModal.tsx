    ...
    >
      <div className="lobby-advanced-config-content">
        <div className="lobby-advanced-config-header">
          ...
          <p>
            {tl(
              '配置此大厅的 EasyTier 高级参数，可以覆盖全局配置',
              'Configure EasyTier advanced parameters for this lobby; these override the global config'
            )}
          </p>
        </div>
        ...
        <Spin spinning={loading}>
          <div className="use-global-config-switch">
            ...
            <Switch checked={useGlobalConfig} onChange={(checked) => setUseGlobalConfig(checked)} />
          </div>
              ...
              <Collapse defaultActiveKey={['network']} className="lobby-advanced-collapse">
                ...
                <Panel header={tl('协议优化', 'Protocol Optimization')} key="protocol">
                  ...
                  <Form.Item
                    ...
                    label={tl('QUIC 监听端口', 'QUIC Listen Port')}
                  >
                    <InputNumber
                      min={0}
                      max={65535}
                ...
                <Panel header={tl('网络设备', 'Network Device')} key="device">
                  ...
                  <Form.Item
                    ...
                    tooltip={
                      isMacOS
                        ? tl(
                            'macOS 使用系统自动分配的 utunN，不能指定固定名称。',
                            'macOS assigns the utunN name automatically; a fixed name is not supported.'
                          )
                        : undefined
                    }
                  >
                    <Input
                      disabled={isMacOS}
                      placeholder={isMacOS ? '系统自动分配 utunN' : 'MCTier_Net'}
                    />
                  </Form.Item>
            ...
            <div className="global-config-hint">
              ...
              <span>
                {tl(
                  ...
                  'Currently using the global config. You can change it in MCTier settings.'
                )}
              </span>
            </div>
          )}
