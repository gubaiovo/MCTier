...
export const ScreenShareManager: React.FC = () => {
  ...
  const handlePasswordSubmit = async () => {
    ...
    try {
      ...
      const stream =
        selectedShare.playerId === currentPlayerId
    ...
    <div className="screen-share-manager">
      ...
      <div className="screen-share-list">
        ...
        <div className="screen-share-hint">
          <InfoIcon size={14} />
          <span>
            {tl('同一个屏幕支持多人同时查看', 'The same screen can be viewed by multiple players')}
          </span>
        </div>
